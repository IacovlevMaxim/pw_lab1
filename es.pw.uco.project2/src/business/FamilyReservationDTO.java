...
public class FamilyReservationDTO extends Reservation {
    ...
    public FamilyReservationDTO(String userId, LocalDate date, int duration, String courtId, float price, int childrenNumber, int adultNumber) throws NoAdultException {
    ...
    public FamilyReservationDTO(String userId, LocalDate date, int duration, String courtId, float price, float discount, int childrenNumber, int adultNumber) throws NoAdultException  {
